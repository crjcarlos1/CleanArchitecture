package com.cralos.cleanarchitecture.framework.datasource.data
...
constructor(
    ...
    fun createSingleNote(id: String? = null, title: String, body: String? = null) =
        noteFactory.createSingleNote(id = id, title = title, body = body)
